import React from "react";const GetStarted = () => {
  return (
    <section>
      <div className="container ">
        <div className="relative">
          <div className=" bg-[#1c2230] absolute left-[50%] translate-x-[-50%] top-[-150px] rounded-[5px] centering flex-col  w-[865px] min-h-[275px]  max-w-full text-white text-center p-[30px]">
